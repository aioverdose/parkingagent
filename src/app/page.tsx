  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] relative">
      ...
      <section className="max-w-4xl mx-auto px-4 pb-12">
        <h2 className="text-center text-sm font-semibold text-[#757575] uppercase tracking-widest mb-6">How it works</h2>
        <div className="grid md:grid-cols-3 gap-4">
          <div className="modern-card text-center p-6">
            <div className="w-10 h-10 bg-gradient-to-br from-[#2563EB] to-[#7C3AED] rounded-full flex items-center justify-center mx-auto mb-3 text-white font-black text-lg">1</div>
          ...
          <div className="modern-card text-center p-6">
            <div className="w-10 h-10 bg-gradient-to-br from-[#2563EB] to-[#7C3AED] rounded-full flex items-center justify-center mx-auto mb-3 text-white font-black text-lg">2</div>
          ...
          <div className="modern-card text-center p-6">
            <div className="w-10 h-10 bg-gradient-to-br from-[#2563EB] to-[#7C3AED] rounded-full flex items-center justify-center mx-auto mb-3 text-white font-black text-lg">3</div>
      ...
      <section className="max-w-3xl mx-auto px-4 pb-8">
        <div className="modern-card p-6 text-center">
          <ul className="space-y-3 text-sm text-[#202124]">
            <li className="flex items-center justify-center gap-2"><span className="w-5 h-5 rounded-full bg-gradient-to-br from-[#2563EB] to-[#7C3AED] flex items-center justify-center text-white text-xs">{"\u2713"}</span> <span><strong>Free for first 100 users</strong> \u2014 1 year free membership, then $4.99/month</span></li>
            <li className="flex items-center justify-center gap-2"><span className="w-5 h-5 rounded-full bg-gradient-to-br from-[#2563EB] to-[#7C3AED] flex items-center justify-center text-white text-xs">{"\u2713"}</span> <span>No money exchanged between members</span></li>
            <li className="flex items-center justify-center gap-2"><span className="w-5 h-5 rounded-full bg-gradient-to-br from-[#2563EB] to-[#7C3AED] flex items-center justify-center text-white text-xs">{"\u2713"}</span> <span>Completely anonymous (Member #1234, not your name)</span></li>
          </ul>
        </div>
      </section>
