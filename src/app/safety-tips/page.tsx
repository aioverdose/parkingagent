      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        <div className="modern-hero px-6 py-10 sm:px-10 sm:py-14 text-center mb-10">
          <div className="relative z-10">
            <h1 className="text-4xl sm:text-5xl font-bold text-white">Safety Tips for Parking Exchanges</h1>
            <p className="text-white/90 mt-3 text-lg">Best practices for safe and secure parking spot exchanges</p>
          </div>
        </div>
