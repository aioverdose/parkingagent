...
export default function AdminLogin() {
  ...
  const [email, setEmail] = useState("admin@parkingagent.com");
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-[#757575] mt-2 text-sm">Admin Login</p>
        </div>
        <form onSubmit={handleSubmit} className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm space-y-4">
          {error && (
            <div className="bg-[#FCE8E6] border border-[#E94335]/30 text-[#E94335] text-sm p-3 rounded-xl">
              {error}
            </div>
          )}
          <div>
